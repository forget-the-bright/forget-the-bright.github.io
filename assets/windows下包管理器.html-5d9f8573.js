import{_ as l,W as t,X as o,Z as e,$ as n,a0 as s,a2 as i,C as r}from"./framework-3a0c4e99.js";const d={},c=e("h1",{id:"windows-下包管理器",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#windows-下包管理器","aria-hidden":"true"},"#"),n(" windows 下包管理器")],-1),p=e("ul",null,[e("li",null,"chocolatey"),e("li",null,"winget"),e("li",null,"Scoop")],-1),u=e("h2",{id:"chocolatey",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#chocolatey","aria-hidden":"true"},"#"),n(" chocolatey")],-1),h=e("p",null,"chocolatey 并非微软官方的包管理器，但却是最受欢迎的包管理器",-1),v={href:"https://chocolatey.org/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://docs.chocolatey.org/en-us/choco/setup",target:"_blank",rel:"noopener noreferrer"},b={href:"https://docs.chocolatey.org/en-us/configuration",target:"_blank",rel:"noopener noreferrer"},g=i(`<h3 id="cmd-安装" tabindex="-1"><a class="header-anchor" href="#cmd-安装" aria-hidden="true">#</a> CMD 安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>@<span class="token string">&quot;%SystemRoot%\\System32\\WindowsPowerShell<span class="token entity" title="\\v">\\v</span>1.0\\powershell.exe&quot;</span> <span class="token parameter variable">-NoProfile</span> <span class="token parameter variable">-InputFormat</span> None <span class="token parameter variable">-ExecutionPolicy</span> Bypass <span class="token parameter variable">-Command</span> <span class="token string">&quot;[System.Net.ServicePointManager]::SecurityProtocol = 3072; iex <span class="token variable"><span class="token punctuation">((</span>New<span class="token operator">-</span>Object System.Net.WebClient<span class="token punctuation">)</span>.DownloadString<span class="token punctuation">(</span>&#39;https<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>community.chocolatey.org<span class="token operator">/</span>install.ps1&#39;<span class="token punctuation">))</span></span>&quot;</span> <span class="token operator">&amp;&amp;</span> SET <span class="token string">&quot;PATH=%PATH%;%ALLUSERSPROFILE%<span class="token entity" title="\\c">\\c</span>hocolatey<span class="token entity" title="\\b">\\b</span>in&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="scoop" tabindex="-1"><a class="header-anchor" href="#scoop" aria-hidden="true">#</a> Scoop</h2><p>Scoop 是一款Windows下的命令行软件管理工具 简单来说,他比winget更强大(只是不够本土化,winget的软件本土化做的要更好一些,但对我来说在环境管理方面,scoop也有不可替代性)</p><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1" aria-hidden="true">#</a> 安装：</h3>`,7),P={href:"https://github.com/ScoopInstaller/Scoop",target:"_blank",rel:"noopener noreferrer"},C={href:"https://github.com/ScoopInstaller/Install",target:"_blank",rel:"noopener noreferrer"},q=i(`<h4 id="非管理员安装" tabindex="-1"><a class="header-anchor" href="#非管理员安装" aria-hidden="true">#</a> 非管理员安装</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Set-ExecutionPolicy RemoteSigned <span class="token parameter variable">-Scope</span> CurrentUser <span class="token comment">#可选:第一次需要执行远程脚本</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="安装缓慢" tabindex="-1"><a class="header-anchor" href="#安装缓慢" aria-hidden="true">#</a> 安装缓慢</h4><p>可以指定环境变量 <code>HTTP_PROXY</code> 设置代理地址来加速</p><h3 id="卸载-1" tabindex="-1"><a class="header-anchor" href="#卸载-1" aria-hidden="true">#</a> 卸载</h3><p>直接删除 <code>SCOOP</code> <code>SCOOP_GLOBAL</code> 环境变量所指的文件夹 可以完全删除</p>`,13);function N(L,D){const a=r("ExternalLinkIcon");return t(),o("div",null,[c,p,u,h,e("p",null,[e("a",v,[n("chocolatey官网"),s(a)])]),e("p",null,[e("a",m,[n("官方安装文档"),s(a)])]),e("p",null,[e("a",b,[n("官方配置文档"),s(a)])]),g,e("p",null,[e("a",f,[n("微软官方文档"),s(a)])]),e("p",null,[e("a",k,[n("winget-GitHub"),s(a)])]),x,e("p",null,[n("前往"),e("a",_,[n("winget-GitHub"),s(a)]),n(" 下载你需要安装版本的安装包 "),S,n(" 下,文件后戳为 "),w,n(" 的安装包 下载完成后双击安装")]),y,e("p",null,[n("打开 PowerShell 终端 (version 5.1 or later) 然后 运行: "),e("a",P,[n("项目地址github"),s(a)]),e("a",C,[n("安装文档github"),s(a)])]),q])}const O=l(d,[["render",N],["__file","windows下包管理器.html.vue"]]);export{O as default};
